...
const PaymentSelect = () => {
  ...
  const allPaymentList = useSelector(
    (state: any) => state.buyerPaymentInfo.BuyerPaymentList
  );
        ...
        <div className="col">
          <div className="m-2">
            {currMode !== null ? (
              ...
              <p className="std-font2">Please Select a Payment Mode</p>
            )}
            {currMode === null ? (
          ...
          <div className="m-2">
            ...
            <ul className="std-ul">
              {allPaymentList !== null && allPaymentList.length > 0 ? (
                allPaymentList.map((mode: any, index: number) => {
                  return (
